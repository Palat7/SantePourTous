...
<div class="container mt-5 ">
    ...
    <form name="rendezVous" method="post" action="traitementRendezvous.php">
        <div class="mb-3">
...
<script>
    ...
    choixVilleSelect.addEventListener('change', function () {
        ...
        if (selectedVille) {
            ...
            xhr.open("GET", "obtenirCliniques.php?ville=" + encodeURIComponent(selectedVille), true);
            xhr.send();
        } else {
    ...
    choixCliniqueSelect.addEventListener('change', function () {
        ...
        if (selectedClinique) {
            ...
            xhr.open("GET", "obtenirMedecins.php?clinique=" + encodeURIComponent(selectedClinique), true);
            xhr.send();
        } else {
    ...
    choixMedecinSelect.addEventListener('change', function () {
        ...
        if (selectedMedecin) {
            ...
            xhr.open("GET", "obtenirDisponibiliteMedecin.php?listeMedecins=" + encodeURIComponent(selectedMedecin), true);
            xhr.send();
        } else {
    ...
    prendreRendezVousBtn.addEventListener('click', function (event) {
        ...
        if (selectedDispo !== null) {
            ...
            xhr.open("POST", "traitementRendezvous.php", true);
